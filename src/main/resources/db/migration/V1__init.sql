...
INSERT INTO md.alert_template (template_name, query_template, alert_name_template, alert_message_template) VALUES
                                                                                                               ('Конверсия платежей по терминалу и провайдеру',
                                                                                                                ...
                                                                                                                'Конверсия платежей по провайдеру ${provider_id} и терминалу ${terminal_id} за последние ${period_minutes} минут меньше ${conversion_rate_threshold}%! Текущее значение: {{ $value }}%');
